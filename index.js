...
client.on('message', message => {
  if(message.content === 'как прошел день?') {
    message.reply('да как обычно, с карателями из Правого Сектора идем после кровавой операции по зачистке детского садика, было съедено 32 ребенка и 2 воспитателя. @вишня#4212' + {files: ["./images/praviysektor.gif"]})   
  }
})
